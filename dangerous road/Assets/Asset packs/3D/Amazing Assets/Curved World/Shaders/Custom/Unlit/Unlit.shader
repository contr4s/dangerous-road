Shader "Amazing Assets/Curved World/Unlit"
{
    Properties
    {
        [CurvedWorldBendSettings] _CurvedWorldBendSettings("0,2,3,5,6,7,8,10|1,2", Vector) = (0, 0, 0, 0)
